...
public class TimerBonusVertical : TimerCore
{
    [SerializeField]
    ...
    {
        get { return PlayerPrefsHelper.GetInt("vBonusesAmount"); }
        set { PlayerPrefsHelper.SetInt("vBonusesAmount", value); }
    }
    [Header("Time setters")]
    [SerializeField]
    ...
    private void Awake()
    {
        BonusButtons.OnColumnBonusActivation += SaveTimeStamp;
    }
    ...
    protected override void Start()
    {
        ...
        if (timerUI == null)
            timerUI = GetComponent<TimerUIVertical>();
    ...
    {
        boardController.ColumnBonusAmount += bonusesAmount;
        bonusesAmount = 0;
        cycleCounter = 0;
        timerUI.RefreshAmount(GetBonusesAmount());
    }
