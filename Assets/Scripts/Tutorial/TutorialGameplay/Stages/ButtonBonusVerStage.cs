...
public class ButtonBonusVerStage : TutorialStage
{
    [SerializeField]
    ...
    public void Accept()
    {
        ...
        TutorialEventList.OnBonusButtonVerticalUsed += EndStage;
        FindObjectOfType<BoardController>().SpawnForButtonVertical();
    }
